...
/** One icon set, one look: 24px grid, 1.75 stroke, rounded caps. */
const PATHS = {
  ...
  chart: '<path d="M3 3v18h18M7 16V9m5 7V5m5 11v-4"/>',
  ...
  cap: '<path d="M22 10 12 5 2 10l10 5 10-5Z"/><path d="M6 12v5c0 1.5 2.7 3 6 3s6-1.5 6-3v-5"/><path d="M22 10v6"/>',
